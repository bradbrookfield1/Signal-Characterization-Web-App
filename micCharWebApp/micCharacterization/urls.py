...
urlpatterns = [
    ...
    path('power-spectrum-list/refreshed/', views_spectral_graphs.PowerSpectrumRefreshedListView.as_view(), name='power-spectrum-list-refreshed'),
    path('mellin-spectrum-list/', views_spectral_graphs.MellinListView.as_view(), name='mellin-spectrum-list'),
    path('mellin-spectrum-list/refreshed/', views_spectral_graphs.MellinRefreshedListView.as_view(), name='mellin-spectrum-list-refreshed'),
